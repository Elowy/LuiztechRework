...
(function () {
  ...
  var DICT = {
    ...
    // Fantázia projekt robot — „kattints ide" buborékok
    'Kattints ide! 👆': 'Click here! 👆',
    'Nézd meg ezt a projektet! 👀': 'Check out this project! 👀',
    'Kattints, és felfedezed! ✨': 'Click to explore! ✨',
    'Kíváncsi vagy a részletekre? Kattints! 🔍': 'Curious about the details? Click! 🔍',
    'Ezt látnod kell — kattints rá! 😍': 'You have to see this — click it! 😍',
    'Egy kattintás, és megnyílik! 🚀': 'One click and it opens! 🚀',
    'Fedezd fel a fantázia projekteket! 💡': 'Explore the concept projects! 💡',
    'Kattints egy kártyára! 🖱️': 'Click a card! 🖱️',
    'Nézz be ide is! 👇': 'Take a look here too! 👇',
    'Itt is lapul pár érdekesség — kattints! 🎁': 'There’s some cool stuff here — click! 🎁',
    'Bátran kattints, nem harapunk! 🤖': 'Go ahead and click, we don’t bite! 🤖',
    'Kukkants be a projektekbe! 👓': 'Peek into the projects! 👓',
